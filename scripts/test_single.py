...
BEST_MODELS_FILE_PATH = LOG_DIR_PATH + "/single_model.csv"
...
if __name__ == "__main__":
    ...
    for model_name in MODEL_NAMES:
        ...
        model_dir_path = LOG_DIR_PATH + "/" + model_name
        ...
        print("\n")
        print("Model Type Name : %s" % model_name)
        print("\n")
        ...
        for best_model_index in best_model_indexs:
            ...
            roc_auc = roc_pr.roc_curve(y, y_probs, model_name)

            print("\n")
            print("Plot the PR Curve")
            pr_auc = roc_pr.pr_curve(y, y_probs, model_name)
            print("\n")

            best_model_results = [[model_name, max_accuracy * 100, losss[best_model_index], precision, recall, f1, roc_auc, pr_auc, best_model_name]]
