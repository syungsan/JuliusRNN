...
## julius executable
$juliusbin="..\\segmentation-kit-4.3.1\\bin\\julius-4.3.1.exe";

## acoustic model
$hmmdefs="../segmentation-kit-4.3.1/models/hmmdefs_monof_mix16_gid.binhmm"; # monophone model
